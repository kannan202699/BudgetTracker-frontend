...
import {
  FiUser, FiMail, FiEdit2, FiSave, FiX, FiShield,
  FiPhone, FiCamera, FiLock, FiEye, FiEyeOff, FiCheck
} from 'react-icons/fi'
...
export default function AdminProfilePage() {
  ...
  useEffect(() => {
    if (user) {
      setForm({ email: user.email || '', fullName: user.fullName || '', phone: user.phone || '' })
    }
  }, [user])
        ...
        <div className="page-header admin-header">
          <div className="header-left">
            <div className="admin-welcome">
              <div className="admin-header-icon"><MdAdminPanelSettings size={32} /></div>
              <div>
        ...
        <div className="profile-layout">
          ...
          <motion.div className="profile-card" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <div className="profile-avatar-wrap" style={{ position: 'relative', display: 'inline-block' }}>
                {user?.profilePicture ? (
                  <img
                    ...
                    alt="Profile"
                    className="profile-avatar-xl profile-avatar-img admin-avatar"
                ...
                >
                  {uploadingAvatar ? <span className="avatar-upload-spinner" /> : <FiCamera size={14} />}
                </button>
            ...
            <div className="profile-stats">
              ...
              <div className="pstat">
                <span className="pstat-val" style={{ color: '#e94057' }}>🛡️</span>
              ...
              <div className="profile-fields">
                ...
                <div className="profile-field">
                  ...
                  <div>
                    ...
                    <span className="field-value">{form.phone || 'Not set'}</span>
                  </div>
                </div>
                <div className="profile-field">
                  ...
                  <div>
                    ...
                    <span className="field-value" style={{ color: '#e94057' }}>Administrator</span>
                  </div>
                </div>
              </div>
            ) : (
